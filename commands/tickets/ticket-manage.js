...
module.exports = {
    name: "ticket-manage",
    description: "Imposta il ticket system.",
    type: 'CHAT_INPUT',
    options: [
        {
            name: 'setup',
            description: 'Imposta il panel dei ticket.',
            type: 'SUB_COMMAND',
            options: [
                {
                    name: 'name',
                    description: 'Il nome del panel.',
                    type: 'STRING',
                    required: true
                },
                {
                    name: 'emoji',
                    description: 'Una emoji da usare.',
                    type: 'STRING',
                    required: true
                },
                {
                    name: 'category',
                    description: 'La categoria del ticket.',
                    type: 'CHANNEL',
                ...
                {
                    name: 'custom-id',
                    description: 'Nome personalizzato per il ticket.',
                    type: 'STRING',
                    required: true
                },
                {
                    name: 'role-1',
                    description: 'Lo staff-role per questo ticket.',
                    type: 'ROLE',
                    required: true
                },
                {
        ...
        {
            name: 'delete',
            description: 'Elimina una categoria ticket.',
            type: 'SUB_COMMAND',
            options: [
                {
                    name: 'custom-id',
                    description: 'Inserisci il nome personalizzato della categoria.',
                    type: 'STRING',
                    required: true
                }
            ]
        ...
        {
            name: 'list',
            description: 'Mostra tutte le categorie ticket create.',
            type: 'SUB_COMMAND'
        },
        {
            name: 'send',
            ...
            options: [
                {
                    name: 'channel',
                    description: 'Dove devo inviare il panel?',
                    type: 'CHANNEL',
